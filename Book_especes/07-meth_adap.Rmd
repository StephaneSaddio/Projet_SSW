...
## Choix du noyau
  ...
  Tout d'abord, nous avons besoin du risque quadratique $\mathcal R$ aussi appelé l'erreur quadratique moyenne (**M**ean **S**quared **E**rror en anglais). Dans cette partie nous allons noté $MSE$ le risque quadratique pour des questions pratiques.  
...
hist(rand, breaks = 12, freq = F, xlab = "valeurs de l'échatillon", ylim = c(0,0.5), main = "")
...
plot(x, risvec, type = "l", xlab = "taille de la fenêtre h",
     ylab = "Risque (MSE)", main= "")
title("Risque estimé en fonction de h \npar validation croisée")
```
